      ...
      <Head />
        ...
        <form onSubmit={(e)=>productSubmit(e)} encType="multipart/form-data" id="imageForm">
         <div className="form-group">
             ...
             <input type="text" value={product.name} onChange={(e)=>setName(e.target.value)}></input>
         </div>
       
         <div className="form-group">
             <label>price:</label>
             <input type="text"  value={product.price} onChange={(e)=>setPrice(e.target.value)}></input>
         </div>
